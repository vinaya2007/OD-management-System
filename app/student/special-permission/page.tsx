...
export default function SpecialPermissionPage() {
  ...
  return (
    <AppShell user={currentUser}>
      <h2 className="mb-4 text-2xl font-bold text-navy">Special Permission</h2>
      <ODTable records={applications.filter((item) => item.studentId === currentUser.id && item.isSpecial)} role="student" />
    </AppShell>
  );
}
